...
internal fun localizedAchievementDescription(
  ...
  when (achievementId) {
    ...
    AchievementId.NoBluffLegend -> localizedTitle(language, "Finish Hardcore with all question variants selected and 0 mistakes/hints.", "Завърши Хардкор със селектирани всички варианти за въпроси и без грешка или подсказки.", "Beende Hardcore mit allen Frage Varianten und ohne Fehler oder Hinweise.")
