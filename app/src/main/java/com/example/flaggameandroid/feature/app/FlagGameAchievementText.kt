...
internal fun localizedAchievementDescription(
  ...
  when (achievementId) {
    ...
    AchievementId.NoBluffLegend -> localizedTitle(language, "Finish No Bluff, All Tough with all three variants selected and 0 mistakes.", "Завърши Без блъф, само трудно със селектирани и трите варианта и без грешка.", "Beende Kein Bluff, alles hart mit allen drei Varianten und ohne Fehler.")
